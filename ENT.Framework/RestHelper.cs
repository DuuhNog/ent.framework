...
{
    public static StringContent GenerateJson(object obj)
    {
    ...
    public static T DeserializeFromJson<T>(string jsonText)
    {
        ...
        var nullless = regex.Replace(jsonText, string.Empty);
    ...
    public static AuthenticationHeaderValue AutenticadorBasicAut(string user, string password) =>
